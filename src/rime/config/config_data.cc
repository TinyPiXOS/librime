...
namespace rime
{
    ...
    // 检查字符串是否只包含字母数字、下划线或点号
    bool is_alnum_or_special(const std::string &str)
    {
                                ...
                                YAML::Emitter *emitter)
    {
        ...
        // else if (!boost::algorithm::all(str_value, boost::algorithm::is_alnum() || boost::algorithm::is_any_of("_.")))
        else if (!is_alnum_or_special(str_value))
        {
