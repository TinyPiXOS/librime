...
namespace rime
{
    ...
    {
        return StringFormatter::format("c=%d d=%d t=%d", commits, dee, tick);
    ...
    bool UserDbValue::Unpack(const string &value)
    {
        ...
        rime::split(kv, value, rime::is_any_of(" "));
                                       ...
                                       Tsv *tsv)
    {
        ...
        rime::split(row, key, rime::is_any_of("\t"));
    ...
    bool UserDbHelper::IsUniformFormat(const string &file_name)
    {
        ...
        return rime::ends_with(file_name, plain_userdb_extension);
    }
