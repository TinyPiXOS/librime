...
namespace rime
{
    ...
    public
    signals:
        declare_signal(CommitNotifier, Context *);
        declare_signal(SelectNotifier, Context *);
        declare_signal(UpdateNotifier, Context *);
        declare_signal(DeleteNotifier, Context *);

        declare_signal(OptionUpdateNotifier, Context *, const string &);
        declare_signal(PropertyUpdateNotifier, Context *, const string &);
        declare_signal(UnhandledKeyEventNotifier, Context *, const KeyEvent &);
