...
namespace rime
{
    ...
    void Context::set_option(const string &name, bool value)
    {
        ...
        OptionUpdateNotifier.emit(this, name);
    }
                               ...
                               const string &value)
    {
        ...
        PropertyUpdateNotifier.emit(this, name);
    }
